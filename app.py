...
async def on_ready():
    ...
    await client.change_presence(activity=discord.Streaming(
        name="Rexy's Cyborg Incarnation", since=0.0, url="https://www.youtube.com/watch?v=dQw4w9WgXcQ")
                                 )
...
client.run("ODIyODg2NTQ0OTgwNzA1MzMw.GyqTHs.Or8X54hLXlLEh4zSMTe8tAs9lxL1BiWu1XArAI")
